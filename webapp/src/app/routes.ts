...
export const ROUTES = {
  ...
  home: "/",
  /** Хаб ролевых чатов: все чаты (бесконечный скролл) + кнопка «Новый чат». */
  chats: "/chats",
  ...
  /** Мастерская: список карточек-черновиков персонажей/персон. */
  cards: "/cards",
  ...
  /** Хаб книг знаний: все книги + кнопка «Создать книгу». */
  books: "/books",
  ...
  /** Настройки приложения (тема оформления, в перспективе — персональные ключи API ИИ). */
  settings: "/settings",
} as const;
