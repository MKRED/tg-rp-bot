// Чистый расчёт состояния полосы «использовано / доступно» токенов для экранов настроек.
// Лимит берётся из пресета (RP-чата или истории); null означает безграничный контекст (или размер не задан).
