...
/** Настройки перехвата, управляемые с экрана отладки (персистятся в user_settings). */
...
export const DEFAULT_DEBUG_SETTINGS: LlmDebugSettings = { enabled: true, maxRequests: 30 };
